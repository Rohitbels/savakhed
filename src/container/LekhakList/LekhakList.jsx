...
class LekhakList extends Component {
  ...
  renderAuthors = () => {
    if (
      ...
      return (
        <div>
          <p>No mentionable authors found.</p>
        </div>
      );
    }
    //else
    ...
    return (
      <div className="lekhakList">
        <div className="toggleBtn">
          <button
            className={
              this.props.activeTab === 1 ? "clickedBtn" : "unclickedBtn"
            }
            onClick={() => {
              this.toggle(1);
            }}
          ...
          <button
            className={
              this.props.activeTab === 2 ? "clickedBtn" : "unclickedBtn"
            }
            onClick={() => {
              this.toggle(2);
            }}
