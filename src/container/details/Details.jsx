	...
	getGoogleData() {
		...
		xhr.addEventListener("load", () => {
			...
			const { result = {}, resultScore = {} } =
				(itemListElement.length && itemListElement[0]) || {};
			const {
				detailedDescription = "",
				name = "",
				description = "",
	...
	render() {
		...
		return (
			<div className="fullDetails">
				<HelmetMetaData
					bookName={currentBook.pustakName}
				></HelmetMetaData>
				...
				<div className="flex-container">
							...
							<div className="cardDetails">
								<div className="book_details">
									...
									<div className="source">
										Book details provided by :{" "}
										{currentBook.usermail}{" "}
									</div>
								</div>
							</div>
						</Card>
					...
					{this.state.GresultScore > 140 &&
						this.state.GarticleBody !== "" && (
							<Card
								bookName={this.state.Gname}
								whichCard="google"
							>
